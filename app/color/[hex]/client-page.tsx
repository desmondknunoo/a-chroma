...
import { ArrowLeft, Copy, Check, Info, Palette, Eye, ShieldCheck, Zap, Globe, Download, Twitter, Github } from "lucide-react";
...
export default function ColorDetailsPage({ params }: { params?: { hex: string } }) {
    ...
    // Ensure valid hex before chroma call
    if (!chroma.valid(hex)) {
        return (
        ...
        <HeroHighlight containerClassName="min-h-screen h-auto">
            <div className="relative z-10 w-full flex flex-col min-h-screen">
                ...
                <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
                    <Link href="/" className="inline-flex items-center text-slate-500 hover:text-slate-900 mb-8 transition-colors bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {technicalData.map((data) => (
                                    <button
                                        ...
                                        className="p-4 bg-white/50 hover:bg-white rounded-2xl border border-slate-100 transition-all text-left group"
                                    >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
                        {/* Description Card */}
                        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-[2rem] shadow-sm border border-slate-100/50 hover:shadow-md transition-shadow">
                    ...
                    {/* Variations */}
                    <section className="mb-24 space-y-12 bg-white/50 backdrop-blur-sm p-12 rounded-[3rem] border border-white/20">
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="flex w-full h-16 rounded-xl overflow-hidden group/list shadow-lg">
                                    {shades.map((s, i) => (
                    ...
                    {/* Harmonies */}
                    <section className="mb-24 py-20 bg-white/80 backdrop-blur-md rounded-[3rem] px-12 border border-white/20">
                    ...
                    <p className="mt-12 text-center text-slate-500 font-medium">
                        All colour data is 100% free to use.
                    </p>
                </main>
