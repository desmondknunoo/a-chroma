        ...
        <div className="flex min-h-screen flex-col bg-white">
          ...
          <main className="flex-1">
            ...
            <div className="flex flex-col border-y border-slate-100">
              <div className="bg-[#4EC7CB] py-4 text-white">
                <MarqueeAnimation baseVelocity={-2} direction="left">
                  Palette Generator &bull; Image Picker &bull; Spacebar Magic &bull;
                </MarqueeAnimation>
              </div>
              <div className="bg-[#8365C5] py-4 text-white">
                <MarqueeAnimation baseVelocity={2} direction="right">
                  Brand Scale &bull; Design Systems &bull; 5-Step Generation &bull;
                </MarqueeAnimation>
              </div>
              <div className="bg-[#EFA128] py-4 text-white">
                <MarqueeAnimation baseVelocity={-2} direction="left">
                  Visual Gradient &bull; Noise Texture &bull; Linear & Radial &bull;
                </MarqueeAnimation>
              </div>
            </div>
