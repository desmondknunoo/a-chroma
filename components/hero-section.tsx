                ...
                <div className="space-y-6 z-10 pt-20 flex justify-center items-center flex-col text-center px-6">
                    ...
                    <div className="flex gap-4 mt-8 flex-wrap justify-center">
                        ...
                        <Link href="/generator">
                            <Button
                                size="lg"
                                className="h-14 md:h-16 rounded-full cursor-pointer px-10 md:px-12 text-base md:text-lg font-bold bg-slate-900 hover:bg-slate-800 text-white shadow-2xl shadow-slate-900/30 transition-all duration-300 hover:scale-105 hover:shadow-xl border-2 border-transparent"
                            >
                        ...
                        <Link href="/gradient">
                            <Button
                                variant="outline"
                                className="h-14 md:h-16 cursor-pointer rounded-full px-10 md:px-12 text-base md:text-lg font-bold border-2 border-[#8365C5] bg-white/50 backdrop-blur-sm text-[#8365C5] hover:bg-[#8365C5] hover:text-white hover:border-[#8365C5] shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
                            >
